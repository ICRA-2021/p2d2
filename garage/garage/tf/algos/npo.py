...
class NPO(BatchPolopt):
    ...
    def optimize_policy(self, itr, samples_data):
        ...
        #policy_adv = self.f_policy_adv(*policy_opt_input_values)
        ...
        logger.record_tabular("{}/KLBefore".format(self.policy.name),
                              policy_kl_before)
        #logger.record_tabular("{}/Advantages".format(self.policy.name),
        #                      policy_adv)
    ...
    def _build_policy_loss(self, i):
        ...
        with tf.name_scope("policy_loss"):
            ...
            self.f_policy_adv = tensor_utils.compile_function(
                flatten_inputs(self._policy_opt_inputs),
                advantages,
