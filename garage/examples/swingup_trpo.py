...
seeds = [218467, 961604, 817351, 842513, 686342, 705797, 233940, 104736, 414054, 568611]

exp_id = 1 
seed = seeds[exp_id - 1]

init_filepath = None
#init_filepath = "/garage/data/local/experiment/networks/trained_rrt_swingup%d.pkl" %exp_id
...
def run_task(*_):
    with LocalRunner() as runner:
        ...
        runner.train(n_epochs=int(2e3+10), batch_size=10 * env.horizon)
